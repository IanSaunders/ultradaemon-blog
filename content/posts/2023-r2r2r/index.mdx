...
* **Strava Activity:** [R2R2R: Part 1 - No sleep start and DNF the DNF](https://www.strava.com/activities/10237430558) and [R2R2R: Part 2 - Redemption & Suffering](https://www.strava.com/activities/10237435385) 
...
![Waiting forever for bags](/images/waiting_for_bags.png)
...
![Huge vista views](/images/mega_view.png)
`Huge vista views`

![View into the canyon](/images/pretty_view.png)
`View into the canyon`

![Sunrise over the Canyon](/images/sunrise.png)
`Sunrise over the Canyon`


![Where we decided to jettison water](/images/fateful_break.png)
`Where we decided to jettison water`


<center>
	<video width="90%" style="max-width:652px" style="max-width:652px" controls>
		<source src="/images/pony_run.mov" />
	</video>
</center>
...
![The pain was real](/images/sufferriing.png)
`The pain was real`


![Hungry!](/images/hungry.jpg)
`Hungry!`
